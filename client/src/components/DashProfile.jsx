  ...
  <div className="relative group">
    ...
    >
      ...
      <img
        src={imageUrl}
        alt={username}
        className={`w-full h-full object-cover ${uploadProgress && uploadProgress < 100 ? 'opacity-60' : ''
          }`}
      />
...
const FormField = memo(({
  ...
  <div>
    ...
    <input
      ...
      onChange={onChange}
      className={`w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border rounded-lg focus:ring-2 focus:outline-none ${error
          ...
          <div className="flex-1">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className={`w-full py-2 px-4 rounded-lg text-white font-medium shadow transition-all ${loading || imageFileUploading
